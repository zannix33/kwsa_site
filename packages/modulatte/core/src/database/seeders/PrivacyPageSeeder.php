...
class PrivacyPageSeeder extends CreatorSeeder
{
    ...
    public function run()
    {
        $data = [            
            ...
            'privacy_nav_text' => 'Privacy Policy',
        ];

        $this->addPageData(2, $data);
